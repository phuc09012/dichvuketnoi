...
class Settings(BaseSettings):
    ...
    motion_threshold: float = Field(default=0.01, alias="MOTION_THRESHOLD")
    peer_endpoints: str = Field(default="", alias="PEER_ENDPOINTS")
    ai_service_url: str = Field(default="http://ai:9000", alias="AI_SERVICE_URL")
    ai_detect_path: str = Field(default="/api/v1/detect", alias="AI_DETECT_PATH")
    ...
    a4_service_url: str = Field(default="", alias="A4_SERVICE_URL")
    a4_detect_path: str = Field(default="/api/v1/detect", alias="A4_DETECT_PATH")
